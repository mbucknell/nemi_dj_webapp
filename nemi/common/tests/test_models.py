...
from common.models import MethodAbstract, StatisticalItemType, MethodTypeRef, SourceCitationRef, InstrumentationRef
...
class TestMethodGetInsertUser(TestCase):
    ...
    def setUp(self):
        self.u1 = User.objects.create_user('user1', 'user1@email', 'password1')
        self.u2 = User.objects.create_user('user2', 'user2@email', 'password2')

        self.instrumentation = InstrumentationRef.objects.create(
