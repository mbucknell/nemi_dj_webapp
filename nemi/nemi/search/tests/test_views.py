...
class TestGeneralSearchView(TestCase):
    ...
    def test_view_no_query(self):
        resp = self.client.get(reverse('search-general'))
...
class TestExportGeneralSearchView(TestCase):
    ...
    def test_view_output_tsv(self):
        resp = self.client.get(reverse('search-general_export_tsv'),
                               {'media_name' : 'all',
                               'source' : 'all',
                               'method_number' : 'all',
                               'instrumentation' : 'all',
    ...
    def test_view_output_xls(self):
        resp = self.client.get(reverse('search-general_export_xls'),
                               {'media_name' : 'all',
                               'source' : 'all',
                               'method_number' : 'all',
                               'instrumentation' : 'all',
...
class TestAnalyteSearchView(TestCase):
    ...
    def test_view_no_query(self):
        resp = self.client.get(reverse('search-analyte'))
        self.assertEqual(resp.status_code, 200)
...
class TestExportAnalyteSearchView(TestCase):
    ...
    def test_view_output_tsv(self):
        resp = self.client.get(reverse('search-analyte_export_tsv'),
                               {'analyte_kind' : 'name',
                                'analyte_value' : 'Po',
                                'media_name' : 'all',
                                'source' : 'all',
    ...
    def test_view_output_xls(self):
        resp = self.client.get(reverse('search-analyte_export_xls'),
                               {'analyte_kind' : 'name',
                                'analyte_value' : 'Po',
                                'media_name' : 'all',
                                'source' : 'all',
...
class TestAnalyteSelectView(TestCase):
    ...
    def test_bad_query(self):
        resp = self.client.get(reverse('search-analyte_select'))
        self.assertEqual(resp.status_code, 200)
...
class TestMicrobiologicalSearchView(TestCase):
    ...
    def test_view_no_query(self):
        resp = self.client.get(reverse('search-microbiological'))
...
class TestBiologicalSearchView(TestCase):
    ...
    def test_view_no_query(self):
        resp = self.client.get(reverse('search-biological'))
...
class TestToxicitySearchView(TestCase):
    ...
    def test_view_no_query(self):
        resp = self.client.get(reverse('search-toxicity'))
...
class TestPhysicalSearchView(TestCase):
    ...
    def test_view_no_query(self):
        resp = self.client.get(reverse('search-physical'))
...
class TestStreamPhysicalSearchView(TestCase):
    ...
    def test_view(self):
        resp = self.client.get(reverse('search-stream_physical'))
...
class TestRegulatorySearchView(TestCase):
    ...
    def test_view_no_query(self):
        resp = self.client.get(reverse('search-regulatory'))
...
class TestExportRegulatorySearchView(TestCase):
    ...
    def test_view_output_tsv(self):
        resp = self.client.get(reverse('search-regulatory_export_tsv'),
                               {'analyte_kind' : 'code',
                                'analyte_value' : 'E-10275',
                                'regulation' : 'all'})
    ...
    def test_view_output_xls(self):
        resp = self.client.get(reverse('search-regulatory_export_xls'),
                               {'analyte_kind' : 'code',
                                'analyte_value' : 'E-10275',
                                'regulation' : 'all'})
...
class TestTabularRegulatorySearchView(TestCase):
    ...
    def test_view_no_query(self):
        resp = self.client.get(reverse('search-tabular_reg'))
